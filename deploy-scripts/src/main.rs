...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_concordium_marlowe"; // Example
    ...
    use concordium_marlowe::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("concordium_marlowe.receive".to_string()),
